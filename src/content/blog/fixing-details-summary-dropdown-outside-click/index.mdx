...
description: "Native <details>/<summary> dropdowns only toggle via their own <summary> — clicking anywhere else leaves them stuck open. Here's the small, dependency-free script that fixes it."
date: 2026-07-30
