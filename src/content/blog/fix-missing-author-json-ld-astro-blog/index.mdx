---
title: "Fixing 'Missing Field Author' in Google's Rich Results Test for an Astro Blog"
...
coverImageAlt: "A magnifying glass over lines of code, representing debugging structured data"
---
...
<Callout type="warning" title="Use set:html with JSON.stringify, not a template string">
