...
Third-party technical coverage (byteiota.com, developersdigest.tech) reports that Claude Opus 4.7 shipped an updated tokenizer counting roughly 1.0 to 1.35 times as many tokens, up to about 35% more, for the same input text compared to the tokenizer pre-4.7 models used.
