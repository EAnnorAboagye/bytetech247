...
This hub is the starting point for a 10-part series. One piece is published so far; the rest are in progress and will be linked here as each one goes live.

1. **[Same Prompt, Different Bill: GPT-5.6 vs Claude vs Gemini](/ai-productivity/same-prompt-different-bill-gpt-claude-gemini/)**: the closing synthesis, tying every provider's change into one cost picture. Published.
2. GPT-5.6's Context Window: 922K In, 128K Out Tokens. In progress.
3. GPT-5.6 Ends Free Prompt-Cache Writes (1.25x Premium). In progress.
4. OpenAI Extends Prompt Cache Retention to 24 Hours. In progress.
5. gpt-4, o1, and o4-mini Shut Down October 23, 2026. In progress.
6. Claude Opus 4.8: Same Price, Cheaper Fast Mode. In progress.
7. Claude's New Tokenizer Counts Up to 35% More. In progress.
8. Claude Opus 4.7 Breaks temperature and top_p Params. In progress.
9. Gemini 3.6 Flash Cuts Output Tokens 17%, Price Too. In progress.
10. OpenAI vs Claude: Prompt Caching Cost Math in 2026. In progress.
