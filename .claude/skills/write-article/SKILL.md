...
Cut these on sight — each is a well-known tell of generated, not authored, text:
...
- Em dashes used as a default transition instead of a real connective
...
- [ ] Sentence lengths visibly vary when you read it aloud.
