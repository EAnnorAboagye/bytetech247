...
Follow the same anti-fabrication discipline as `dev-tools-article` and `guides-fixes-article`: **do not use AI image generation for this category**, a fabricated-looking payload or dashboard screenshot undermines trust in a post whose whole premise is a verified integration change.
