...
- Status: written
- Slug: vitest-5-beta-breaking-changes
...
- Status: written
- Slug: fix-vitest-5-vi-mock-top-level-scope-error
...
- Status: written
- Slug: fix-vitest-5-clearmocks-breaking-mock-state
...
- Status: written
- Slug: fix-vitest-5-test-sequential-removed-error
...
- Status: written
- Slug: fix-vitest-5-config-not-found-parent-directory
...
- Status: written
- Slug: fix-vitest-5-bench-no-longer-top-level-export
...
- Status: written
- Slug: fix-vitest-5-unawaited-async-assertion-error
...
- Status: written
- Slug: fix-vitest-5-expect-poll-timeout-error
...
- Status: written
- Slug: fix-vitest-5-cannot-find-module-vitest-reporters
...
- Status: written
- Slug: fix-vitest-5-tothrow-empty-string-silently-passing
...
- Status: written
- Slug: fix-vitest-5-projects-not-inheriting-root-config
